...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    with launch_simulation(env_cfg, args_cli):
        ...
        # launch_simulation() already resolved the per-rank device for distributed runs;
        # only apply a CLI --device override when not distributed (else it clobbers it).
        ...
        if args_cli.distributed:
            ...
            # env_cfg.sim.device was resolved by launch_simulation() (respects CUDA_VISIBLE_DEVICES).
